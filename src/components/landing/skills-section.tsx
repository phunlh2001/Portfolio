...
const mainSkills = [
  ...
  { name: ".NET", icon: <Briefcase size={48} /> },
  ...
  { name: "Express.JS", icon: <Network size={48} /> },
  { name: "NestJS", icon: <Cloud size={48} /> },
...
const extraSkills = [
  { name: "React", icon: <Puzzle size={48} /> },
  ...
  { name: "Bootstrap", icon: <Box size={48} /> },
  { name: "jQuery", icon: <MousePointerClick size={48} /> },
